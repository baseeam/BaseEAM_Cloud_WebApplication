...
namespace BaseEAM.Data.Mapping
{
    public class AssetMap : BaseEamEntityTypeConfiguration<Asset>
    {
            ...
            : base()
        {
            ...
            this.HasOptional(e => e.AssetCategory)
                .WithMany()
            ...
            this.Property(e => e.DepreciationLifeSpan).HasPrecision(19, 4);
            this.Property(e => e.DepreciationOriginalValue).HasPrecision(19, 4);
            this.Property(e => e.DepreciationEndValue).HasPrecision(19, 4);
            this.Property(e => e.AccumulatedDepreciation).HasPrecision(19, 4);
            this.Property(e => e.CurrentPeriodDepreciation).HasPrecision(19, 4);
            this.Property(e => e.UndepreciatedBalance).HasPrecision(19, 4);
        }
    }
}
