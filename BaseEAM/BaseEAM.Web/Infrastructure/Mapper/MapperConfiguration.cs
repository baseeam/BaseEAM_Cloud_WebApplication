    ...
    public class MapperConfiguration : IMapperConfiguration
    {
        ...
        public Action<IMapperConfigurationExpression> GetConfiguration()
        {
            Action<IMapperConfigurationExpression> action = cfg =>
            {
                ...
                cfg.CreateMap<TenantPaymentCollection, TenantPaymentCollectionModel>();
                cfg.CreateMap<TenantPaymentCollectionModel, TenantPaymentCollection>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //TenantPayment
                cfg.CreateMap<TenantPayment, TenantPaymentModel>()
                    .ForMember(dest => dest.TenantId, opt => opt.MapFrom(src => src.Tenant.Id));
                cfg.CreateMap<TenantPaymentModel, TenantPayment>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //Tenant
                cfg.CreateMap<Tenant, TenantModel>();
                cfg.CreateMap<TenantModel, Tenant>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //SLAInstance
                cfg.CreateMap<SLAInstance, SLAInstanceModel>();
                cfg.CreateMap<SLAInstanceModel, SLAInstance>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //SLAInstanceTerm
                cfg.CreateMap<SLAInstanceTerm, SLAInstanceTermModel>();
                cfg.CreateMap<SLAInstanceTermModel, SLAInstanceTerm>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //SLADefinition
                cfg.CreateMap<SLADefinition, SLADefinitionModel>();
                cfg.CreateMap<SLADefinitionModel, SLADefinition>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //SLATerm
                cfg.CreateMap<SLATerm, SLATermModel>();
                cfg.CreateMap<SLATermModel, SLATerm>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                cfg.CreateMap<NotificationSequence, NotificationSequenceModel>();
                cfg.CreateMap<NotificationSequenceModel, NotificationSequence>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                // TenantLease
                cfg.CreateMap<TenantLease, TenantLeaseModel>()
                    .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Assignment == null ? "" : src.Assignment.Name))
                    .ForMember(dest => dest.AvailableActions, opt => opt.MapFrom(src => src.Assignment == null ? null : src.Assignment.AvailableActions))
                    .ForMember(dest => dest.AssignedUsers, opt => opt.MapFrom(src => src.Assignment == null ? null :
                        string.Join(";", src.Assignment.Users.Select(u => u.Name))));
                cfg.CreateMap<TenantLeaseModel, TenantLease>()
                    .ForMember(dest => dest.Number, src => src.Ignore())
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                ...
                cfg.CreateMap<TenantLeasePaymentSchedule, TenantLeasePaymentScheduleModel>();
                cfg.CreateMap<TenantLeasePaymentScheduleModel, TenantLeasePaymentSchedule>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //TenantLeaseCharge
                cfg.CreateMap<TenantLeaseCharge, TenantLeaseChargeModel>();
                cfg.CreateMap<TenantLeaseChargeModel, TenantLeaseCharge>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                // RequestForQuotationPrintModel
                cfg.CreateMap<RequestForQuotation, RequestForQuotationPrintModel>();

                //RequestForQuotationVendorItem
                cfg.CreateMap<RequestForQuotationVendorItem, RequestForQuotationVendorItemModel>()
                    .ForMember(dest => dest.Sequence, opt => opt.MapFrom(src => src.RequestForQuotationItem.Sequence))
                    .ForMember(dest => dest.ItemId, opt => opt.MapFrom(src => src.RequestForQuotationItem.ItemId))
                    .ForMember(dest => dest.ItemName, opt => opt.MapFrom(src => src.RequestForQuotationItem.Item.Name))
                    .ForMember(dest => dest.ItemUnitOfMeasureId, opt => opt.MapFrom(src => src.RequestForQuotationItem.Item.UnitOfMeasureId))
                    .ForMember(dest => dest.ItemUnitOfMeasureName, opt => opt.MapFrom(src => src.RequestForQuotationItem.Item.UnitOfMeasure.Name))
                    .ForMember(dest => dest.QuantityRequested, opt => opt.MapFrom(src => src.RequestForQuotationItem.QuantityRequested));
                cfg.CreateMap<RequestForQuotationVendorItemModel, RequestForQuotationVendorItem>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                cfg.CreateMap<RequestForQuotationVendor, RequestForQuotationVendorModel>();
                cfg.CreateMap<RequestForQuotationVendorModel, RequestForQuotationVendor>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                cfg.CreateMap<RequestForQuotationItem, RequestForQuotationItemModel>();
                cfg.CreateMap<RequestForQuotationItemModel, RequestForQuotationItem>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                // RequestForQuotation
                cfg.CreateMap<RequestForQuotation, RequestForQuotationModel>()
                    .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Assignment == null ? "" : src.Assignment.Name))
                    .ForMember(dest => dest.AvailableActions, opt => opt.MapFrom(src => src.Assignment == null ? null : src.Assignment.AvailableActions))
                    .ForMember(dest => dest.AssignedUsers, opt => opt.MapFrom(src => src.Assignment == null ? null :
                        string.Join(";", src.Assignment.Users.Select(u => u.Name))));
                cfg.CreateMap<RequestForQuotationModel, RequestForQuotation>()
                    .ForMember(dest => dest.IsSent, src => src.Ignore())
                    .ForMember(dest => dest.Number, src => src.Ignore())
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                ...
                //PurchaseRequestItem
                cfg.CreateMap<PurchaseRequestItem, PurchaseRequestItemModel>();
                cfg.CreateMap<PurchaseRequestItemModel, PurchaseRequestItem>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                // PurchaseRequest
                cfg.CreateMap<PurchaseRequest, PurchaseRequestModel>()
                    .ForMember(dest => dest.Status, opt => opt.MapFrom(src => src.Assignment == null ? "" : src.Assignment.Name))
                    .ForMember(dest => dest.AvailableActions, opt => opt.MapFrom(src => src.Assignment == null ? null : src.Assignment.AvailableActions))
                    .ForMember(dest => dest.AssignedUsers, opt => opt.MapFrom(src => src.Assignment == null ? null :
                        string.Join(";", src.Assignment.Users.Select(u => u.Name))));
                cfg.CreateMap<PurchaseRequestModel, PurchaseRequest>()
                    .ForMember(dest => dest.Number, src => src.Ignore())
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                ...
                cfg.CreateMap<PurchaseOrder, PurchaseOrderPrintModel>();

                //PurchaseOrderMiscCost
                cfg.CreateMap<PurchaseOrderMiscCost, PurchaseOrderMiscCostModel>();
                cfg.CreateMap<PurchaseOrderMiscCostModel, PurchaseOrderMiscCost>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                //PurchaseOrderItem
                cfg.CreateMap<PurchaseOrderItem, PurchaseOrderItemModel>()
                    .ForMember(dest => dest.SiteId, opt => opt.MapFrom(src => src.PurchaseOrder.SiteId));
                cfg.CreateMap<PurchaseOrderItemModel, PurchaseOrderItem>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
                ...
                // AutomatedAction
                cfg.CreateMap<AutomatedAction, AutomatedActionModel>();
                cfg.CreateMap<AutomatedActionModel, AutomatedAction>()
                    .ForMember(dest => dest.CreatedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedDateTime, src => src.Ignore())
                    .ForMember(dest => dest.CreatedUser, src => src.Ignore())
                    .ForMember(dest => dest.ModifiedUser, src => src.Ignore());
