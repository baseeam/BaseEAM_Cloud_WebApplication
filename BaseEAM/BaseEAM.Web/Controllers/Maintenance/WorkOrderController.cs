...
namespace BaseEAM.Web.Controllers
{
    public class WorkOrderController : BaseController
    {
        ...
        public ActionResult Edit(WorkOrderModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!string.IsNullOrEmpty(model.ActionName))
                {
                    ...
                    // close SLA instance if possible
                    this._workflowBaseService.CloseSLAInstance(workOrder.Id, EntityType.WorkOrder, assignment.Name);
                }
        ...
        #region CreateWOForLocation

        [HttpPost]
        [BaseEamAuthorize(PermissionNames = "Maintenance.WorkOrder.Create")]
        public ActionResult CreateWOForLocation(long locationId)
        {
        ...
        #region CreateWOForAsset

        [HttpPost]
        [BaseEamAuthorize(PermissionNames = "Maintenance.WorkOrder.Create")]
        public ActionResult CreateWOForAsset(long assetId)
        {
