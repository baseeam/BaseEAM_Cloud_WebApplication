    ...
    public class SiteController : BaseController
    {
        ...
        public JsonResult LocationList(long parentValue, string param)
        {
            var locations = _locationRepository.GetAll()
                ...
                .Select(l => new SelectListItem { Text = l.HierarchyNamePath, Value = l.Id.ToString() })
                .ToList();
        ...
        /// <summary>
        /// Get the list of properties of a site
        /// </summary>
        /// <param name="parentValue">siteId</param>
        /// <param name="param">The text input from user</param>
        [HttpPost]
        public JsonResult PropertyList(long parentValue, string param)
        {
            ...
            {
                properties.Insert(0, new SelectListItem { Value = "", Text = "" });
            }
