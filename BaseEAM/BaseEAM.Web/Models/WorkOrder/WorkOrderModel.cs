...
namespace BaseEAM.Web.Models
{
    ...
    public class WorkOrderModel : BaseEamEntityModel
    {
        ...
        [BaseEamResourceDisplayName("WorkOrder.IsEquipmentDown")]
        public bool IsEquipmentDown { get; set; }

        [BaseEamResourceDisplayName("WorkOrder.EquipmentDownStartDateTime")]
        [UIHint("DateTimeNullable")]
        public DateTime? EquipmentDownStartDateTime { get; set; }

        [BaseEamResourceDisplayName("WorkOrder.EquipmentDownEndDateTime")]
        [UIHint("DateTimeNullable")]
        public DateTime? EquipmentDownEndDateTime { get; set; }
