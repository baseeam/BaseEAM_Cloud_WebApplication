...
namespace BaseEAM.Services
{
    public class WorkflowBaseService : IWorkflowBaseService
    {
        ...
        protected readonly IRepository<SLAInstance> _slaInstanceRepository;
        ...
        public virtual void CloseSLAInstance(long entityId, string entityType, string assignmentName)
        {
            if(assignmentName == WorkflowStatus.Closed || assignmentName == WorkflowStatus.Cancelled)
            {
                ...
                if (slaInstance != null)
                {
                    slaInstance.Closed = true;
                    _slaInstanceRepository.UpdateAndCommit(slaInstance);
                }
            }
        }
    }
